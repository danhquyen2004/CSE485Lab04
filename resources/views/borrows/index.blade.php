            ...
            <tbody>
                @forelse ($borrows as $borrow)
                    <tr>
                        ...
                        <td>{{ $borrow->return_date ? \Carbon\Carbon::parse($borrow->return_date)->format('d/m/Y') : 'Not Returned' }}
                        </td>
                        <td>
                        ...
                        <td>
                            <a href="{{ route('borrows.show', $borrow->id) }}" class="btn btn-info btn-sm"><i
                            class="bi bi-eye"></i></a>
                            <a href="{{ route('borrows.edit', $borrow->id) }}" class="btn btn-warning btn-sm"><i
